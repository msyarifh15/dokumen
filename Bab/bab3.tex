...
\hspace{0,5cm}Diagram \textit{use case} oleh pengguna aplikasi dapat dilihat pada Gambar~\ref{fig:diagram_use_case}

\begin{figure}
\centering
\resizebox{\textwidth}{!}{
\includegraphics{Gambar/use-case}
}
\caption[Diagram \textit{Use Case}]{Diagram \textit{Use Case}} 
\label{fig:diagram_use_case}
\end{figure}
