...
Phonegap menggunakan HTML5 dan CSS3 untuk me-\textit{render} aplikasi dan Javascript digunakan untuk menjalankan logika dari aplikasi yang dibuat. Phonegap membangun API yang dapat digunakan oleh pengembang aplikasi di atas OS \textit{mobile device}. Arsitektur Phonegap dapat dilihat pada Gambar~\ref{fig:arsitektur_phonegap} 

%Jelasin dulu apat itu HTML 5, CSS 3, Javascript, trus jelasin juga API itu apa
...
Webservice merupakan suatu sistem yang menyediakan fungsi-fungsi dari suatu perangkat lunak diatas internet melalui \textit{web}. %jelasin lebih jauh lagi, penjelasan gk bsa cuma segini. Anggep lu buat tulisan untuk orang awam, kasi contoh.
...
%apa itu webservice? lu jelasin dlu. Apa maksud dari "`"gaya arsitektur suatu perangkat lunak yang terdiri dari pedoman dan praktek terbaik?'
...
%apa itu third party? Third parti disini lu harus jelasin, third party hardware, software atau apa? Trus apa itu HTTP, ujug-ujug keluar HTTP tapi gk lu jelasin apa itu HTTP. Akses token itu apa? Harus lu jelasin.
