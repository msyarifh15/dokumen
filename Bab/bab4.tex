...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/login}
}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/kategori}
}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/rumah_tangga}
}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/dashboard}
}
\caption[Tampilan halaman dashboard]{Tampilan halaman dashboard} 
\label{fig:design_web_dashboard_rumah_tangga}
\end{figure}

\begin{figure}
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/anggota}
}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[scale=0.01]{Gambar/mockup-admin/laporan}
}
